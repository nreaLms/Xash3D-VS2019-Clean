...
static void UI_MultiPlayer_Init( void )
{
	...
	uiMultiPlayer.internetGames.generic.x = UI_MAINSELECTION_POSX;
	...
	uiMultiPlayer.spectateGames.generic.x = UI_MAINSELECTION_POSX;
	...
	uiMultiPlayer.LANGame.generic.x = UI_MAINSELECTION_POSX;
	...
	uiMultiPlayer.Customize.generic.x = UI_MAINSELECTION_POSX;
	...
	uiMultiPlayer.Controls.generic.x = UI_MAINSELECTION_POSX;
	...
	uiMultiPlayer.done.generic.x = UI_MAINSELECTION_POSX;
