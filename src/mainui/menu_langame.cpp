...
static void UI_LanGame_Init( void )
{
	...
	uiLanGame.joinGame.generic.x = UI_MAINSELECTION_POSX;
	...
	uiLanGame.createGame.generic.x = UI_MAINSELECTION_POSX;
	...
	uiLanGame.gameInfo.generic.x = UI_MAINSELECTION_POSX;
	...
	uiLanGame.refresh.generic.x = UI_MAINSELECTION_POSX;
	...
	uiLanGame.done.generic.x = UI_MAINSELECTION_POSX;
