...
static void UI_InternetGames_Init( void )
{
	...
	uiInternetGames.joinGame.generic.x = UI_MAINSELECTION_POSX;
	...
	uiInternetGames.createGame.generic.x = UI_MAINSELECTION_POSX;
	...
	uiInternetGames.gameInfo.generic.x = UI_MAINSELECTION_POSX;
	...
	uiInternetGames.refresh.generic.x = UI_MAINSELECTION_POSX;
	...
	uiInternetGames.done.generic.x = UI_MAINSELECTION_POSX;
