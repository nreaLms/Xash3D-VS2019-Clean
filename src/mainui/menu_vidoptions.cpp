...
static void UI_VidOptions_Init( void )
{
	...
	uiVidOptions.background.generic.width = ScreenWidth;
	uiVidOptions.background.generic.height = ScreenHeight;
	uiVidOptions.background.pic = ART_BACKGROUND;
	uiVidOptions.background.generic.ownerdraw = UI_Background_Ownerdraw;
	...
	uiVidOptions.done.generic.x = UI_MAINSELECTION_POSX;
	...
	uiVidOptions.screenSize.generic.x = UI_MAINSELECTION_POSX;
	...
	uiVidOptions.gammaIntensity.generic.x = UI_MAINSELECTION_POSX;
	...
	uiVidOptions.glareReduction.generic.x = UI_MAINSELECTION_POSX;
